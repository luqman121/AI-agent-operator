...
export const metadata: Metadata = { title: "Agentive | AI Agency Automation for Your Business", description: "We build custom AI agents and smart workflows that answer your customers instantly, qualify leads, and book appointments around the clock." };
