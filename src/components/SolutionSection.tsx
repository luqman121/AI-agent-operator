...
const points = [
  ...
  "Qualifies your leads automatically — collects name, needs, and budget",
  ...
  "Runs on n8n workflows built and managed for you — no technical skills needed",
];
