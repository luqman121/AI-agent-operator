...
const features = [
  ...
  { icon: Filter, title: "Smart lead qualification", description: "Asks the right questions up front, like budget, timeline, and needs, so you only spend time on serious buyers.", color: "text-brand-500", bgColor: "bg-brand-50" },
